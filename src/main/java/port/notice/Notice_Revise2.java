...
public class Notice_Revise2 {

	
	String msg = null;

	public Notice_Revise2(ArrayList<String> ar) throws ClassNotFoundException, SQLException {
		setter(ar);
	}
	...
	public void setter(ArrayList<String> ar) throws ClassNotFoundException, SQLException {
		...
		String sql = "update notice set chk=?,title=?,file=?,memo=? where idx=?";
