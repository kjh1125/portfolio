...
public class Category_Insert2 {

	
	String msg = null;

	public Category_Insert2(ArrayList<String> ar) throws ClassNotFoundException, SQLException {
		setter(ar);
	}
	...
	public void setter(ArrayList<String> ar) throws ClassNotFoundException, SQLException {
		...
		String sql = "insert into cate_list values('0',?,?,?,?,?,?)";
