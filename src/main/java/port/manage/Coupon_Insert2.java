...
public class Coupon_Insert2 {

	
	String msg = null;

	public Coupon_Insert2(ArrayList<String> ar) throws ClassNotFoundException, SQLException {
		setter(ar);
	}
	...
	public void setter(ArrayList<String> ar) throws ClassNotFoundException, SQLException {
		...
		String sql = "insert into newcoupon values('0',?,?,?,?,?,?,?,?)";
