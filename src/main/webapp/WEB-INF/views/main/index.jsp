...
<link rel="stylesheet" type="text/css" href="./css/slick.css?v=20221019"><!-- 반응형 슬라이드 -->
<link rel="stylesheet" type="text/css" href="./css/goods_info_style.css"><!-- 상품디스플레이 CSS -->
<link rel="stylesheet" type="text/css" href="./css/lib.css" />
<link rel="stylesheet" type="text/css" href="./css/common.css?v=20221019" />
...
<link rel="stylesheet" type="text/css" href="./css/user.css?v=20221019" /><!-- ++++++++++++ 스킨 사용자/제작자 CSS ++++++++++++ -->
...
<script type="text/javascript">
	...
	function collection(n){
		location.href="./index.do?code="+n+"#menu";
