...
String mainid = (String)session.getAttribute("mainid")==null?"":(String)session.getAttribute("mainid");
...
<meta charset="utf-8">
    ...
    <a href='#' target='_self'>
    <img src='/portfolio/images/popup_16327281123906.jpg' />
    </a>
    </div>
    <div class='designPopupClose'>
    <img src='/portfolio/images/btn_tbanner_close.png' alt='banner close' />
    </div>
    </div>
    <div class='designPopupBandBtn absolute center hand hide' style='top:0px; left:50%; width:200px; margin-left:-100px;z-index:12'>
    <img src='/portfolio/images/band_btn_open.gif' />
    </div>
<!-- //띠배너 -->
...
<div id="layout_header" class="layout_header">
	<div class="logo_wrap">
		<div class="resp_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/portfolio/index.do' target='_self'><img src="/portfolio/images/logo.png" title="인테리어 TRENDY LIVING IDEA" alt="인테리어 TRENDY LIVING IDEA"></a>
			</h1>

            <!-- 상단 유틸메뉴 -->
            <ul class="util_wrap_menu2">
                
                <%if(mainid.equals("")){out.print("<li><a href='/portfolio/member_login.do' designElement='text' textIndex='4' target='_self'>로그인</a></li>");} %>
                <%if(!mainid.equals("")){out.print("<li><a>"+mainid+"</a></li>");} %>
				<%if(!mainid.equals("")){out.print("<li><a href='./mainlogout.do' designElement='text' textIndex='4' target='_self'>로그아웃</a></li>");} %>
				
				
				<li>
					<a href="/portfolio/member.do" designElement="text" textIndex="5" target="_self">회원가입</a>
				</li>
                <!-- <li><a href="/service/cs" designElement="text">CS CENTER</a></li> -->
                <li class="respCartArea"><a href="./cart.do"><em designElement="text" textIndex="6">CART</em></a></li>
			...
			<div class="gnb_bnr_slide gnb_bnr_slide_02 slider_before_loading" style="display:none; position:absolute; right:40px; top:0px; width:220px; height:148px;">
				<div class="slider_gon">
                    ...
                    <img class="simg" src="/portfolio/banner/images_1.png" /></a>
                    </div>
                    <div class="sslide"><a class="slink" href="" target="_self">
                    <img class="simg" src="/portfolio/banner/images_2.png" /></a>
                    </div>	
				...
				<div class="designCategoryNavigation">
					<ul class="respCategoryList">
						...
						<li class="nav_category_all ">
							<a class="categoryAllBtn" designElement="text" textIndex="8" href="#" target="_self">PRODUCT<br>
                            </a>
		...
		<div class="categorySub">
			<div class="categorySubWrap">
				...
				<div class="categorySubBanner">
					<p xss="removed" style="text-align: left;"><img src="" class="txc-image" style="text-align: center; font-size: 9pt; clear: none; float: none;" /></p><p xss="removed" style="text-align: left;"><br></p><p xss="removed"><br></p>
				</div>
			</div>
		</div>
	</li>
	<li class="categoryDepth1">
		...
		<div class="categorySub">
			<div class="categorySubWrap">
				...
				<div class="categorySubBanner">
					<p xss="removed"><img src="" class="txc-image" style="text-align: center; font-size: 9pt; clear: none; float: none;" /></p><p xss="removed"><br></p>
				</div>
			</div>
		</div>
	</li>
	...
	<li class="categoryDepth1">
		...
		<div class="categorySub">
			<div class="categorySubWrap">
				...
				<div class="categorySubBanner">
					<p xss="removed" style="text-align: left;"><img src="" class="txc-image" style="clear:none;float:none;" /></p><p xss="removed"><br></p>
				</div>
			</div>
		</div>
	</li>
	...
	<li class="categoryDepth1">
		<a class="categoryDepthLink designElement" designelement="category" href="/goods/catalog?code=0007"><em>DEZ ITALIA</em></a>
						...
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="9" href="#" target="_self">PROMOTION</a>
						</li>
						<!--<li class="custom_nav_link">
                         ...
                         <li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="10" href="#" target="_self">STORE</a>
						</li>	
                        
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="11" href="/portfolio/cs.do/0" target="_self">CUSTOMER CENTER</a>
						</li>
					</ul>
				</div>
			</div>
